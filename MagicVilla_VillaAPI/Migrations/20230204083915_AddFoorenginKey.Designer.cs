...
namespace MagicVillaVillaAPI.Migrations
{
    ...
    [Migration("20230204083915_AddFoorenginKey")]
    partial class AddFoorenginKey
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MagicVilla_VillaAPI.Models.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 2, 4, 14, 39, 15, 235, DateTimeKind.Local).AddTicks(9734),
                        ...
                        new
                        {
                            Id = 2,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 2, 4, 14, 39, 15, 235, DateTimeKind.Local).AddTicks(9750),
                        ...
                        new
                        {
                            Id = 3,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 2, 4, 14, 39, 15, 235, DateTimeKind.Local).AddTicks(9751),
                            Details = "As we all know, a paragraph is a",
                        ...
                        new
                        {
                            Id = 4,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 2, 4, 14, 39, 15, 235, DateTimeKind.Local).AddTicks(9753),
                            Details = "As we all know, a paragraph is a",
                        ...
                        new
                        {
                            Id = 5,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 2, 4, 14, 39, 15, 235, DateTimeKind.Local).AddTicks(9754),
                            Details = "As we all know, a paragraph is a",
