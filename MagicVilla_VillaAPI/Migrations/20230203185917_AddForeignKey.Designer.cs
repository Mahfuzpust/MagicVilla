...
namespace MagicVillaVillaAPI.Migrations
{
    ...
    [Migration("20230203185917_AddForeignKey")]
            ...
            modelBuilder.Entity("MagicVilla_VillaAPI.Models.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 2, 4, 0, 59, 17, 893, DateTimeKind.Local).AddTicks(1744),
                        ...
                        new
                        {
                            Id = 2,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 2, 4, 0, 59, 17, 893, DateTimeKind.Local).AddTicks(1754),
                        ...
                        new
                        {
                            Id = 3,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 2, 4, 0, 59, 17, 893, DateTimeKind.Local).AddTicks(1755),
                            Details = "As we all know, a paragraph is a",
                        ...
                        new
                        {
                            Id = 4,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 2, 4, 0, 59, 17, 893, DateTimeKind.Local).AddTicks(1757),
                            Details = "As we all know, a paragraph is a",
                        ...
                        new
                        {
                            Id = 5,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 2, 4, 0, 59, 17, 893, DateTimeKind.Local).AddTicks(1758),
                            Details = "As we all know, a paragraph is a",
