...
namespace MagicVillaVillaAPI.Migrations
{
    ...
    [Migration("20230204084322_ADDVilllaNumber")]
    partial class ADDVilllaNumber
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MagicVilla_VillaAPI.Models.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 2, 4, 14, 43, 22, 562, DateTimeKind.Local).AddTicks(2341),
                        ...
                        new
                        {
                            Id = 2,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 2, 4, 14, 43, 22, 562, DateTimeKind.Local).AddTicks(2350),
                        ...
                        new
                        {
                            Id = 3,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 2, 4, 14, 43, 22, 562, DateTimeKind.Local).AddTicks(2352),
                            Details = "As we all know, a paragraph is a",
                        ...
                        new
                        {
                            Id = 4,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 2, 4, 14, 43, 22, 562, DateTimeKind.Local).AddTicks(2354),
                            Details = "As we all know, a paragraph is a",
                        ...
                        new
                        {
                            Id = 5,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 2, 4, 14, 43, 22, 562, DateTimeKind.Local).AddTicks(2355),
                            Details = "As we all know, a paragraph is a",
