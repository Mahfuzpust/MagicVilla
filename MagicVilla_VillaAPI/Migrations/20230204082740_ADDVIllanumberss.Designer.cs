...
namespace MagicVillaVillaAPI.Migrations
{
    ...
    [Migration("20230204082740_ADDVIllanumberss")]
    partial class ADDVIllanumberss
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MagicVilla_VillaAPI.Models.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 2, 4, 14, 27, 40, 619, DateTimeKind.Local).AddTicks(9184),
                        ...
                        new
                        {
                            Id = 2,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 2, 4, 14, 27, 40, 619, DateTimeKind.Local).AddTicks(9194),
                        ...
                        new
                        {
                            Id = 3,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 2, 4, 14, 27, 40, 619, DateTimeKind.Local).AddTicks(9195),
                            Details = "As we all know, a paragraph is a",
                        ...
                        new
                        {
                            Id = 4,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 2, 4, 14, 27, 40, 619, DateTimeKind.Local).AddTicks(9197),
                            Details = "As we all know, a paragraph is a",
                        ...
                        new
                        {
                            Id = 5,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 2, 4, 14, 27, 40, 619, DateTimeKind.Local).AddTicks(9198),
                            Details = "As we all know, a paragraph is a",
