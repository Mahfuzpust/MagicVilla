...
namespace MagicVillaVillaAPI.Migrations
{
    ...
    [Migration("20230203165024_AddTableFiveDocoment")]
    partial class AddTableFiveDocoment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MagicVilla_VillaAPI.Models.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 2, 3, 22, 50, 24, 905, DateTimeKind.Local).AddTicks(9837),
                        ...
                        new
                        {
                            Id = 2,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 2, 3, 22, 50, 24, 905, DateTimeKind.Local).AddTicks(9849),
                        ...
                        new
                        {
                            Id = 3,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 2, 3, 22, 50, 24, 905, DateTimeKind.Local).AddTicks(9851),
                            Details = "As we all know, a paragraph is a",
                        ...
                        new
                        {
                            Id = 4,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 2, 3, 22, 50, 24, 905, DateTimeKind.Local).AddTicks(9852),
                            Details = "As we all know, a paragraph is a",
                        ...
                        new
                        {
                            Id = 5,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 2, 3, 22, 50, 24, 905, DateTimeKind.Local).AddTicks(9854),
                            Details = "As we all know, a paragraph is a",
