...
namespace MagicVillaVillaAPI.Migrations
{
    ...
    [Migration("20230203184607_AddVillaNumber")]
            ...
            modelBuilder.Entity("MagicVilla_VillaAPI.Models.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 2, 4, 0, 46, 6, 984, DateTimeKind.Local).AddTicks(186),
                        ...
                        new
                        {
                            Id = 2,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 2, 4, 0, 46, 6, 984, DateTimeKind.Local).AddTicks(205),
                        ...
                        new
                        {
                            Id = 3,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 2, 4, 0, 46, 6, 984, DateTimeKind.Local).AddTicks(207),
                            Details = "As we all know, a paragraph is a",
                        ...
                        new
                        {
                            Id = 4,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 2, 4, 0, 46, 6, 984, DateTimeKind.Local).AddTicks(208),
                            Details = "As we all know, a paragraph is a",
                        ...
                        new
                        {
                            Id = 5,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 2, 4, 0, 46, 6, 984, DateTimeKind.Local).AddTicks(210),
                            Details = "As we all know, a paragraph is a",
